...
public class BrandBoutiqueAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(MyApplication.context).load(hotSellData.getResult().getModulelist().get(1).getList().get(position).getLogo())
                .error(R.mipmap.ic_launcher).into(holder.iconIv);
        holder.titleTv.setText(hotSellData.getResult().getModulelist().get(1).getList().get(position).getTitle());
        holder.adinfoTv.setText(hotSellData.getResult().getModulelist().get(1).getList().get(position).getAdinfo());
        holder.priceTv.setText(hotSellData.getResult().getModulelist().get(1).getList().get(position).getPrice());
        holder.fctPriceTv.setText(hotSellData.getResult().getModulelist().get(1).getList().get(position).getFctprice());
        //设置textview的线
